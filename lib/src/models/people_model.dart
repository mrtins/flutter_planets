...
import 'package:stars/src/services/people_repository.dart';
...
class PeopleScoped extends Model {
  PeopleScoped(this._peopleRepository);
  ...
  void loadUserData() {
    _isLoading = true;
    notifyListeners();
    _peopleRepository.getPeople().then((user) {
      _people = user;
      _isLoading = false;
      notifyListeners();
    });
